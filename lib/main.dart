//i will change that app so that when user open app it will go to collection in firebase users doc phone then field faceJpg and save it in the local dbthen when user click button the identify button it will identify that image
...
void printFullString(Uint8List uint8List) {
